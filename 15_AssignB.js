...
console.log(`1.-------Find all employees from TCS company-------`);
...
console.log(`3.--------------------- Find the Employee Whoes Name Start With 'R' ----------------------`);
for (const nameEmployee of array_employees) {
    if (nameEmployee.emp_name.startsWith("R")) {
        console.log(nameEmployee);
    }
}
console.log(`4.------------------ Find the Employee Whoes Salary Greater than 75000 -------------------`);
...
console.log(`5.--------------- Find the Employee Whoes Salary Greater than Equal 50000 ----------------`);
for (const employeeSalary of array_employees) {
    if (employeeSalary.emp_salary>=50000 && employeeSalary.emp_dept=="IT") {
       console.log(employeeSalary); 
    }
}
console.log(`6.---------------------------Find all employees from Infy company-------------------------`);
